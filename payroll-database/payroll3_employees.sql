...
CREATE TABLE `employees` (
  ...
  CONSTRAINT `FK_dpt_id` FOREIGN KEY (`dpt_id`) REFERENCES `departments` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `employees` VALUES (1,3,'Jake','Smith',32),(2,1,'Sandy','Small',36),(3,2,'John','Doe',30),(4,4,'Sarah','Smith',38);

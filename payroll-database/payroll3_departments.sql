...
CREATE TABLE `departments` (
  ...
  `hrly_rate` double NOT NULL,
  `basic_hrs` int NOT NULL,
  PRIMARY KEY (`id`),
...
INSERT INTO `departments` VALUES (1,'Operations',95.35,40),(2,'Sales & Marketing',100.45,40),(3,'Administration',125.35,40),(4,'Accounts',150.25,45);

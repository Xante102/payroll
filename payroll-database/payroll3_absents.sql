...
CREATE TABLE `absents` (
  ...
  `emp_id` int NOT NULL,
  `absent_dt` date NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `id_UNIQUE` (`id`),
  KEY `emp_id_idx` (`emp_id`),
  CONSTRAINT `FK_emp_id` FOREIGN KEY (`emp_id`) REFERENCES `employees` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `absents` VALUES (1,3,'2022-07-11');

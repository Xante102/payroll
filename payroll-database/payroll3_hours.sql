...
CREATE TABLE `hours` (
  ...
  `ovt_hrs` int NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `id_UNIQUE` (`id`),
  KEY `FK3_emp_id_idx` (`emp_id`),
  KEY `FK_paycycle_id_idx` (`paycycle_id`),
  CONSTRAINT `FK3_emp_id` FOREIGN KEY (`emp_id`) REFERENCES `employees` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_paycycle_id` FOREIGN KEY (`paycycle_id`) REFERENCES `paycycles` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `hours` VALUES (1,3,34,1,5);
